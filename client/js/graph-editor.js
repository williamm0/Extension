var graphEditor = (function () {
    ...
    function setCurve(curve) {
        if (!curve || !curve.h1 || !curve.h2) return;
        h1 = { x: clamp01(parseFloat(curve.h1.x)), y: clampRange(parseFloat(curve.h1.y)) };
        h2 = { x: clamp01(parseFloat(curve.h2.x)), y: clampRange(parseFloat(curve.h2.y)) };
        redraw();
    }
