            ...
            walkProps(sel[i], function(prop) {
                ...
                for (var k = 1; k <= prop.numKeys; k++) {
                    ...
                    try {
                        ...
                        var safeIn  = Math.max(0.1, Math.min(100, easeInInf));
                        var safeOut = Math.max(0.1, Math.min(100, easeOutInf));
                        var eIn = [], eOut = [];
                        for (var d = 0; d < dim; d++) {
                            eIn.push(new KeyframeEase(0, safeIn));
                            eOut.push(new KeyframeEase(0, safeOut));
                        }
